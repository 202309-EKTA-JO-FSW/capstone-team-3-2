...
const LandingPage = () => {
 ...
 <div>
        ...
        <div className="bg-gray-200 py-16 flex justify-center items-center w-full mb-8 relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between w-full items-center cursor-pointer" onClick={toggleSteps}>
          ...
          {showSteps && (
           ...
           <div className="bg-white p-8 rounded-lg border border-yellow-500 shadow-lg flex flex-row items-center">
             <div className="mr-4">
  ...
  <div className="flex flex-col">
    ...
    <p className="text-gray-700">Choose a restaurant and a mouthwatering dish. The perfect quick bite is just a click away</p>
        ...
        <div className=" py-16  ">
          <div className="  flex flex-col justify-center items-center w-full mb-8 relative  ">
            <div className="text-center">
              <div>
              <h1 className="text-4xl font-semibold text-black mb-8">Join The DishDash Community</h1>
</div>

<div>
  <div className="bg-white p-8 rounded-lg shadow-md flex flex-row items-center border border-yellow-500 shadow-lg">
    <img src="https://assets.api.uizard.io/api/cdn/stream/e246370c-8563-4926-bbe9-d1d44b872ab7.png" alt="become a rider" className="w-12 h-12 object-cover rounded-full mr-4" />
    <div>
   ...
   <div>
     <div className="bg-white p-8 rounded-lg shadow-md flex flex-row items-center border border-yellow-500 shadow-lg">
                  <img src="https://assets.api.uizard.io/api/cdn/stream/3de66382-a1d7-41e9-add0-73355e305e95.png" alt="partner with us" className="w-10 h-10 object-cover rounded-full mr-4" />
                  <div>
...
<div>
                <div className="bg-white p-8 rounded-lg shadow-md flex flex-row items-center border border-yellow-500 shadow-lg">
                  <img src="https://assets.api.uizard.io/api/cdn/stream/5731af9d-856a-4f19-be88-ace58e953529.png" alt="join our team" className="w-10 h-10 object-cover rounded-full mr-4" />
                  <div>
