...
<div className="bg-gray-200 py-16 ">
  ...
  <div className="bg-white p-8 rounded-lg border border-yellow-500 shadow-lg flex flex-col items-center">
    <img src="https://assets.api.uizard.io/api/cdn/stream/7dc79fea-dfab-43c4-8c3c-4d3c302573fb.png" alt="step 1" className="w-24 h-24 object-cover rounded-lg mb-4" />
  ...
  <div className="bg-white p-8 rounded-lg border border-yellow-500 shadow-lg flex flex-col items-center">
    <img src="https://assets.api.uizard.io/api/cdn/stream/a46630bd-9a0c-4b7c-bb3c-6b0f4f2d3b31.png" alt="step 2" className="w-24 h-24 object-cover rounded-full mb-4" />
  ...
  <div className="bg-white p-8 rounded-lg border border-yellow-500 shadow-lg flex flex-col items-center">
    <img src="https://assets.api.uizard.io/api/cdn/stream/6992293c-39ad-4d51-873e-64bf26754ab0.png" alt="step 3" className="w-24 h-24 object-cover rounded-full mb-4" />
