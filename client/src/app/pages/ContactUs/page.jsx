...
const ContactPage = () => {
    ...
    const reasons = ['I can not login', 'Report a problem', 'Feedback'];
...
<form onSubmit={handleSubmit}>
            <div className="flex flex-col  justify-center  ">
                <div style={{padding:"2rem"}}><h2 className='font-bold'>Submit a request
</h2></div>


<div className="mb-4  relative">
                <input ref={subjectRef} placeholder="Select a reason" type="text" id="subject" className="mt-1 px-2 py-2 w-full cursor-pointer" 
...
>
              ...
              <div className="mb-4 w-[800px] ">
                <input ref={emailRef} placeholder="Email" type="email" id="email" className="mt-1 px-2 py-2 w-full  " />

              </div>
              
            </div>
            <div className="mb-4">
              <textarea ref={messageRef} placeholder="Write us a message" id="message" className="mt-2 px-2 py-4 w-full"  />
             
            </div>
            <div className="flex justify-center  ">
              <button type="submit" className=" font-bold py-2 bg-gray-300 hover:bg-pink-100 focus:bg-pink-100 disabled:opacity-50 disabled:cursor-not-allowed"   style={{ transition: 'background-color 0.3s', backgroundColor: 'transparent' }}
        ...
        >Submit
          ...
          {message && (
              <div className={`flex justify-center items-center text-white font-md text-center w-full mx-[2rem] py-4 rounded-3xl mt-4 
